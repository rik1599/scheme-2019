...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |laboratorio 25_10_2018 (2)|) (read-case-sensitive #t) (teachpacks ((lib "drawing.ss" "installed-teachpacks"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "drawing.ss" "installed-teachpacks")) #f)))
;; Square-Cross Puzzle
...
; Quadrato
(glue-tiles
 (glue-tiles (shift-down (quarter-turn-right larger-tile) 2)
             (shift-down (quarter-turn-right smaller-tile) 2)
             )
 (glue-tiles (shift-right (quarter-turn-left larger-tile) 1)
             (shift-right (shift-down (quarter-turn-left smaller-tile) 2) 5)
             )
 )